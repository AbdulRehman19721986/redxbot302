...
// make true if you want auto reply on status 
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*SEEN YOUR STATUS BY REDXBOT 🖤*",
...
BOT_NAME: process.env.BOT_NAME || "REDXBOT",
// add bot namw here for menu
STICKER_NAME: process.env.STICKER_NAME || "REDXBOT",
...
LIVE_MSG: process.env.LIVE_MSG || "> HEY IM ALIVE NOW  *REDXBOT*⚡",
// add alive msg here 
